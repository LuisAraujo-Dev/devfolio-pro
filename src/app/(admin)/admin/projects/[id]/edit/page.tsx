...
export default async function EditProjectPage({
  ...
  // 1. Buscar os dados atuais do projeto
      ...
      <form action={updateProjectWithId} className="space-y-6">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Editor de Conteúdo (Placeholder por enquanto) */}
            <div className="rounded-xl border border-white/10 bg-surface p-6 space-y-4">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border border-white/10 bg-surface p-6 space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label htmlFor="isVisible" className="text-sm text-muted cursor-pointer select-none">
                  Visível no Site?
                </label>
                <input
                  id="isVisible"
              ...
              <div className="flex items-center justify-between border-t border-white/5 pt-4">
                <label htmlFor="featured" className="text-sm text-muted cursor-pointer select-none">
                  Projeto em Destaque?
                </label>
                <input
                  id="featured"
